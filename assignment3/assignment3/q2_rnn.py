...
class Config:
    ...
    def __init__(self, args):
        ...
        if "model_path" in args:
            ...
            #self.output_path = "C:\\Users\\Lenovo\\Downloads\\cs224nd\\assignment3\\assignment3\\results\\{}\\{:%Y%m%d_%H%M%S}\\".format(self.cell, datetime.now())
...
def pad_sequences(data, max_length):
    ...
    for sentence, labels in data:
        ...
        #while (len(sentence) < max_length):
            ...
            #mask[len(labels)-1] = False
        #ret.append((sentence, labels, mask.tolist()))
...
class RNNModel(NERModel):
    ...
    def add_prediction_op(self):
        ...
        #print(preds)
        #print('preds.shape:', tf.stack(preds).shape)
